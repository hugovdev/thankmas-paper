...
package me.hugo.thankmas.util

public interface BiMap<K : Any, V : Any> : Map<K, V> {
    override val values: Set<V>
    public val inverse: BiMap<V, K>
}

public interface MutableBiMap<K : Any, V : Any> : BiMap<K, V>, MutableMap<K, V> {
...
public abstract class AbstractBiMap<K : Any, V : Any> protected constructor(
    ...
    public constructor() : this(HashMap(), HashMap())
...
public class HashBiMap<K : Any, V : Any>(capacity: Int = 16) :
    AbstractBiMap<K, V>(HashMap(capacity), HashMap(capacity)) {
    public companion object {
        public fun <K : Any, V : Any> create(map: Map<K, V>): HashBiMap<K, V> {
